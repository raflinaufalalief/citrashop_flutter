    ...
    return BlocListener<UserBloc, UserState>(
      listener: (context, state) {
        ...
        if (state is UserLoading) {
          ...
          // Contoh: Memperbarui keranjang belanja, mendapatkan pesanan, dll.
          ...
          // Menangani kegagalan login, menampilkan pesan kesalahan
              ...
              child: Column(
                ...
                children: [
                  ...
                  InputFormButton(
                    ...
                    onClick: () {
                      if (_formKey.currentState!.validate()) {
                        // Menjalankan aksi login menggunakan BLoC
                        context.read<UserBloc>().add(SignInUser(SignInParams(
                              username: emailController.text,
                              password: passwordController.text,
                            )));
